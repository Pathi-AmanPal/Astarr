<!-- SUPERSEDED 2026-09-06. This is the v1 "audit working paper" direction --
     green-bar ledger stock, hairlines, no radius, no shadow -- retired when the
     interface was rebuilt as an instrument face. It is archived rather than deleted
     because it is the record of what the screens were, and because the reasoning in
     it (achromatic field, severity as an edge mark, tabular figures) is what the
     current direction was argued against. The live document is /DESIGN.md. -->
